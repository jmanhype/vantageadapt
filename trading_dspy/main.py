...
def main():
    try:
        # Configure logging with loguru's default style
        # Clear output.log at the start of each run
        ...
        # Add file handler for output.log
        logger.add("output.log")
        
        # Add console handler with loguru's default style
        logger.add(
            sys.stderr,
        ...
        # Save results using custom encoder for datetime objects
